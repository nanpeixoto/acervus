...
class StatusCurso {
  ...
  factory StatusCurso.fromJson(Map<String, dynamic> json) {
    return StatusCurso(
      id: json['cd_status'],
      nome: json['descricao'] ?? '',
      descricao: json[''] ?? '',
  ...
  @override
  String toString() {
    return 'StatusCurso{id: $id, nome: $nome, ativo: $ativo, descricao: $descricao, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt}';
  }

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is StatusCurso &&
  ...
  static List<StatusCurso> getStatusPadrao() {
    return [
      StatusCurso(
        id: 1,
        nome: 'Ativo',
