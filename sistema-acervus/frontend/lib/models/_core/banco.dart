// TODO Implement this library.// TODO Implement this library.// lib/models/banco.dart
class Banco {
  final int? id;
  final String nome;
  ...
  @override
  String toString() {
    return 'Banco{id: $id, nome: $nome, ativo: $ativo, descricao: $descricao, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt}';
  }
  ...
  static List<Banco> getStatusPadrao() {
    return [
      Banco(
        id: 1,
        nome: 'Ativo',
