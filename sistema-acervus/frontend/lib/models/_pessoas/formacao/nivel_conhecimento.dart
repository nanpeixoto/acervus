...
class NivelConhecimento {
  ...
  factory NivelConhecimento.fromJson(Map<String, dynamic> json) {
    return NivelConhecimento(
      id: json['cd_nivel_conhecimento'],
      nome: json['descricao'] ?? '',
      descricao: json[''] ?? '',
      cor: json['cor'],
      ordem: json['ordem'],
  ...
  @override
  String toString() {
    return 'NivelConhecimento{id: $id, nome: $nome, ativo: $ativo, descricao: $descricao, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt}';
  }

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is NivelConhecimento &&
  ...
  static List<NivelConhecimento> getStatusPadrao() {
    return [
      NivelConhecimento(
        id: 1,
        nome: 'Ativo',
