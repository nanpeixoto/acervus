...
class Idioma {
  ...
  @override
  String toString() {
    return 'Idioma{id: $id, nome: $nome, ativo: $ativo, descricao: $descricao, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt}';
  }

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Idioma && runtimeType == other.runtimeType && id == other.id;

  @override
  int get hashCode => id.hashCode;

  // Status padrão do sistema
  static List<Idioma> getStatusPadrao() {
    return [
      Idioma(
        id: 1,
        nome: 'Ativo',
