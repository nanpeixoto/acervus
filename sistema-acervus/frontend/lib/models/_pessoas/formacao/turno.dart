// TODO Implement this library.// lib/models/turnos.dart
class Turno {
  final int? id;
  final String nome;
  ...
  @override
  String toString() {
    return 'Turno{id: $id, nome: $nome, ativo: $ativo, descricao: $descricao, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt}';
  }
  ...
  static List<Turno> getStatusPadrao() {
    return [
      Turno(
        id: 1,
        nome: 'Ativo',
