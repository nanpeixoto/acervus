...
class Conhecimento {
  ...
  factory Conhecimento.fromJson(Map<String, dynamic> json) {
    return Conhecimento(
      id: json['cd_conhecimento'],
  ...
  @override
  String toString() {
    return 'Conhecimento{id: $id, nome: $nome, ativo: $ativo, descricao: $descricao, createdBy: $createdBy, updatedBy: $updatedBy, createdAt: $createdAt, updatedAt: $updatedAt}';
  }

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Conhecimento &&
  ...
  static List<Conhecimento> getStatusPadrao() {
    return [
      Conhecimento(
        id: 1,
        nome: 'Ativo',
